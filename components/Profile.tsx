    ...
    />
            ...
            <div className='flex flex-col md:basis-2/3 p-4 justify-center   '>
                ...
                <p className='mt-4 text-lg'>
                    ...
                    journey. Currently, I am seeking for an <span className='text-[#43b1b1]'>3 month internship</span> as a software engineer or mobile application developer
                    for the <span className='text-[#43b1b1]'>summer of 2024 (June 2024)</span>. Message me to understand more about me.
                </p>

...
import { projectsProps } from "./constant";
      ...
      <div className="flex flex-col m-2 p-2">
        <div className="flex flex-col sm:flex-row p-2">
          <div className="flex-col justify-evenly ml-4">
            <Image src={cover} width={200} height={200} alt="Cover img" />
            <p className="text-lg font-semibold text-[#43b1b1] mt-4">{title}</p>
            <div className="flex flex-row mt-3 gap-3 py-2 justify-start">
              ...
              {video && (
                <div className="flex flex-row gap-2">
                  <Icons.videoIcon className="h-6 w-6" />
                  <VideoModal videoSrc={video} />
                </div>
              )}
            </div>
            {feature != undefined && (
